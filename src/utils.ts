...
export function crc32(str: string): number {
    ...
    for (let i = 0, iTop = str.length; i < iTop; i++) {
        ...
        x = '0x' + crcTable.substring(y * 9, (y * 9) + 8);
        crc = (crc >>> 8) ^ x;
    }
    return crc ^ (-1);
}